            ...
            <motion.div key={idx} className="group" whileHover="hover">
              <a href={item.link} className="flex flex-col gap-[1.6rem]">
                <div className="relative aspect-auto overflow-hidden rounded-[2.4rem] lg:aspect-[1/0.7]">
                  ...
                  <div className="pointer-events-none invisible absolute left-[50%] top-[50%] inline-flex h-[10rem] w-[10rem] translate-x-[-50%] translate-y-[-50%] items-center justify-center rounded-[50%] bg-Pure_White opacity-[0] transition-all duration-300 group-hover:pointer-events-auto group-hover:visible group-hover:opacity-[1]">
                    <FaArrowTurnDown className="-rotate-90 text-[3.5rem] text-Charcoal_Black" />
                  </div>
                </div>
                ...
                <div className="relative flex flex-col gap-[3.4rem] overflow-hidden rounded-[2.4rem] border-t border-[#424242] bg-[#1a1a1a] py-[2rem] sm:py-[4rem]">
                  ...
                  >
                    <h4 className="text-[3rem] font-medium leading-[3.2rem] tracking-[-0.9px]">
                      {item.title}
                    </h4>
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-[15px] hidden lg:block"
                  >
